...
\begin{onecolentry}
Software Engineer who builds and owns features end-to-end and Founding Engineer at Univest with 3+ years building real-time trading platforms and data-driven applications from the ground up. Deep expertise in React.js, Next.js, and Flutter, with hands-on experience architecting Redux Toolkit/Redux-Saga state layers, encrypted WebSocket pipelines for live market data, and secure payment flows. Proven track record of shipping high-impact features in Agile teams, with a focus on performance, scalability, and clean architecture.
\end{onecolentry}

\section{Work Experience}
\begin{twocolentry}{\textit{Aug 2022 – Present}}
\textbf{Sr. Software Engineer (Founding Engineer)} $|$ \textit{Univest.in (Gurugram, Delhi NCR)}
\end{twocolentry}
\begin{onecolentry}
\begin{highlights}
...
\item Engineered a low-latency WebSocket layer consuming AES-encrypted live price feeds from stock exchanges, enabling sub-second UI updates with full data integrity across concurrent sessions.
...
\end{onecolentry}
\begin{onecolentry}
\textbf{OTA Updates for Flutter} — \href{https://shorebird.dev}{}
Integrated Shorebird-based over-the-air update pipeline for Flutter apps, enabling instant patch delivery without app store re-submissions.
\end{onecolentry}
\begin{onecolentry}
\textbf{Dcluttr} — \href{https://app.dcluttr.ai}{} \textit{(Freelance)}
...
Web Development Mentor at Google Developer Student Clubs (GDSC), BBDNITM (Jun 2022 – May 2023).
\end{onecolentry}
